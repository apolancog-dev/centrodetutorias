...
const N8N_API_URL = "https://n8n.centrodetutorias.com/api/v1/workflows/hITGXdI6ECjNDtYe";
...
const workflowPath = "/Users/antoniopolanco/Library/CloudStorage/GoogleDrive-apolancog@gmail.com/Mi unidad/NEGOCIOS/CENTRO DE TUTORIAS/CETU AGENT/n8n/guardar_lead_whatsapp.json";
...
try {
  ...
  const payload = {
    name: workflowData.name || "Guardar Lead desde WhatsApp",
    nodes: workflowData.nodes || [],
    connections: workflowData.connections || {},
    settings: workflowData.settings || {}
  };

  console.log("Enviando petición PUT a la API de n8n para actualizar Guardar Lead desde WhatsApp...");
